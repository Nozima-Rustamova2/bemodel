...
COLUMNS_TO_ADD = [
    ("models", "city", "VARCHAR"),
    ("site_settings", "academy_headline", "VARCHAR"),
    ("site_settings", "academy_subheadline", "VARCHAR"),
    ("site_settings", "brand_name", "VARCHAR"),
    ("site_settings", "brand_city", "VARCHAR"),
    ("site_settings", "hero_pre", "VARCHAR"),
    ("site_settings", "hero_em", "VARCHAR"),
    ("site_settings", "hero_post", "VARCHAR"),
    ("site_settings", "hero_body", "TEXT"),
    ("site_settings", "manifesto_title", "VARCHAR"),
    ("site_settings", "manifesto_body1", "TEXT"),
    ("site_settings", "manifesto_body2", "TEXT"),
    ...
    ("site_settings", "manifesto_image_key", "VARCHAR"),
    ...
    ("site_settings", "hero_subheadline_ru", "VARCHAR"),
    ("site_settings", "hero_pre_ru", "VARCHAR"),
    ("site_settings", "hero_em_ru", "VARCHAR"),
    ("site_settings", "hero_post_ru", "VARCHAR"),
    ("site_settings", "hero_body_ru", "TEXT"),
    ("site_settings", "manifesto_title_ru", "VARCHAR"),
    ("site_settings", "manifesto_body1_ru", "TEXT"),
    ("site_settings", "manifesto_body2_ru", "TEXT"),
    ...
    ("site_settings", "academy_headline_ru", "VARCHAR"),
    ("site_settings", "academy_subheadline_ru", "VARCHAR"),
